...
sealed class WorldStateGameSync : IDisposable
{
    ...
    public unsafe WorldStateGameSync(WorldState ws, ActionManagerEx amex)
    {
        ...
        _processPacketFateInfoHook = Service.Hook.HookFromSignature<ProcessPacketFateInfoDelegate>("E8 ?? ?? ?? ?? E9 ?? ?? ?? ?? 0F B7 4B 10 48 8D 56 12 41 B8 ?? ?? ?? ??", ProcessPacketFateInfoDetour);
