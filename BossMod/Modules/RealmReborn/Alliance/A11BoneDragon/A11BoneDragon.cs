...
public class A11BoneDragon(WorldState ws, Actor primary) : BossModule(ws, primary, new ArenaBoundsUnion([
    new ArenaBoundsCircle(new(-450, 30), 15), new ArenaBoundsRect(new(-450, 0), 20, 10, -90.Degrees())]))
{
