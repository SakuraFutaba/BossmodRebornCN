...
[ModuleInfo(BossModuleInfo.Maturity.WIP, Contributors = "The Combat Reborn Team", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 735, NameID = 10004)]
public class DAL2Cuchulainn(WorldState ws, Actor primary) : BossModule(ws, primary, new ArenaBoundsCircle(new(650, -187.5f), 25));