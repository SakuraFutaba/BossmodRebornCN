...
{
    private List<Actor> _castersEruptionAOEFirst = new();
    private List<Actor> _castersEruptionAOESecond = new();
...
public class DAL1Sartauvoir : BossModule
{
    ...
    public DAL1Sartauvoir(WorldState ws, Actor primary) : base(ws, primary, new ArenaBoundsSquare(new(631, 157), 20))
    {
