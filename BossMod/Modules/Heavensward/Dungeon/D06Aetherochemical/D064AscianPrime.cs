using BossMod.Heavensward.Dungeon.D06Aetherochemical.D063LahabreaIgeyorhm;
...
public class D064AscianPrime(WorldState ws, Actor primary) : BossModule(ws, primary, new ArenaBoundsCircle(new(230, 79), 20));